...
def run(prompt, steps, width, height, images, scale):
    ...
    return grid, all_samples_images
    
def process_run(prompt, steps, width, height, images, scale):
    grid, all_samples_images = run(prompt, steps, width, height, images, scale)
